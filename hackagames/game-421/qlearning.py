...
class Qlearning421() :
    ...
    def train(self, nb_training = 10000):
        for episode in range(nb_training):
            ...
            temporal_difference = reward + ( self.discount_factor * np.max( self.q_values[old_dice[0] - 1, old_dice[1] - 1, old_dice[2] - 1])) - old_q_value
